...
test("HI2-05R final certification bundle can be generated from the approved candidate", () => {
  ...
  const candidate = read("delivery/hi2-05r-certification-candidate.json");
  const approval = read("delivery/hi2-05r-certification-approval.json");
  ...
  console.log("HI2_05R_CERTIFIED=" + JSON.stringify(certified));
});
