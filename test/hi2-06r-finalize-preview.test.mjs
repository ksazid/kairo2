...
test("HI2-06R final certification bundle can be generated from the approved candidate", () => {
  ...
  const candidate = read("delivery/hi2-06r-certification-candidate.json");
  const approval = read("delivery/hi2-06r-certification-approval.json");
  ...
  console.log("HI2_06R_CERTIFIED=" + JSON.stringify(certified));
});
