...
test("HI2-10E certified bundle remains valid after append-only graph revisions",()=>{
 ...
 const bundle=read("delivery/hi2-10e-certified.json");
 const verification=verifyCertifiedBundle(bundle,{graph,governance,policy,authority:config.authority,currentCommitSha:bundle.commitSha});
