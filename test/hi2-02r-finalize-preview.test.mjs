...
test("HI2-02R final certification bundle can be generated from approved candidate", () => {
  ...
  const approval = read("delivery/hi2-02r-certification-approval.json");
  ...
  console.log("HI2_CERTIFIED_BUNDLE=" + JSON.stringify(certified));
});
