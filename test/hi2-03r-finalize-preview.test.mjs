...
test("HI2-03R final certification bundle can be generated from the approved candidate", () => {
  ...
  const candidate = read("delivery/hi2-03r-certification-candidate.json");
  const approval = read("delivery/hi2-03r-certification-approval.json");
  ...
  console.log("HI2_03R_CERTIFIED=" + JSON.stringify(certified));
});
